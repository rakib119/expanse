...
<li class="nav-item ">
    <a class="nav-link {{isset($users_active)? 'active' : ''}} text-capitalize " href="#" data-toggle="collapse" aria-expanded="false" data-target="#employee_sub_menu"
        aria-controls="employee_sub_menu"><i class="fa fa-fw fa-user-circle"></i>Employee</a>
...
<li class="nav-item ">
    <a class="nav-link  {{isset($expanses_active)? 'active' : ''}} text-capitalize " href="#" data-toggle="collapse" aria-expanded="false" data-target="#exppanses_sub_menu"
...
<li class="nav-item ">
    <a class="nav-link {{isset($product_active)? 'active' : ''}} text-capitalize " href="#" data-toggle="collapse" aria-expanded="false" data-target="#Product_sub_menu"
    ...
    <div id="Product_sub_menu" class="collapse submenu">
        <ul class="nav flex-column">
            ...
            <li class="nav-item">
                <a class="nav-link " href="{{route('product.index')}}">Listtt</a>
            </li>
        </ul>
    </div>
</li>
