...
<li class="nav-item ">
    <a class="nav-link text-capitalize " href="#" data-toggle="collapse" aria-expanded="false" data-target="#exppanses_sub_menu"
...
<li class="nav-item ">
    <a class="nav-link text-capitalize " href="#" data-toggle="collapse" aria-expanded="false" data-target="#Product_sub_menu"
