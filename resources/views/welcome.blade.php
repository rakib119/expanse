                    ...
                    <div class="card-body p-0">
                        <ul class="social-sales list-group list-group-flush">
                            ...
                            <li class="list-group-item d-flex align-items-center"><span
                                    ...
                                    class="ml-auto text-dark">56
                                    Sales</span>
                            </li>
                            <li class="list-group-item d-flex align-items-center"><span
                                    class="icon-shape icon-lg rounded-circle text-white bg-googleplus mr-2"><i
                                        class="fab fa-google-plus-g') }}"></i></span><span class="">Google
                                    Plus</span><span class="ml-auto text-dark">36 Sales</span>
                            </li>
                        </ul>
                    </div>
