        ...
        <div class=" col-12">
            <div class="card mb-5 shadow-sm">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        <a href="{{ route('expanse.index') }}" class="btn btn-secondary">  Expanse List <i class="fa fa-arrow-right"></i></a>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-sm-12 mb-3">
                                ...
                                <input required type="number" name="amount" min="1"
                                    ...
                                    id="amount" placeholder="Enter expanse amount">
                                @error('amount')
                                    <span class="text-danger"> {{ $message }}</span>
                                @enderror
                            </div>
                            <div class="col-lg-12 col-sm-12 mb-3">
                                ...
                                <textarea name="remarks" id="remarks" class="form-control @error('remarks') is-invalid @enderror " cols="30"
                                    rows="4" placeholder='Please give a explanation'>{{ old('remarks') }}</textarea>
                                @error('remarks')
                                    <span class="text-danger"> {{ $message }}</span>
                                @enderror
                            </div>
